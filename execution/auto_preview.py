...
- **Telemetry Link**: Search `[auto_preview]` in system logs.
"""
...
def start_server(port=3000):
    ...
    print(f"🚀 [OK] Starting preview on port {port}...")
...
def status_server():
    ...
    print("\n[SESSION-STATUS] Preview Overview")
    if running:
