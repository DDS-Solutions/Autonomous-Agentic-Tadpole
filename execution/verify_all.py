...
### AI Assist Note
**🚀 Tadpole Engine: Full Verification Suite**
...
- **Telemetry Link**: Search `[verify_all]` in system logs.
"""

#!/usr/bin/env python3
"""
# 🚀 Tadpole Engine: Full Verification Suite
**Agent Consistency**: High (Sovereign Level)
**Source of Truth**: `execution/verify_all.py`, `docs/Benchmark_Spec.md`
**Inputs**: Project Path, Target URL
**Outputs**: Consolidated Verification Report (Exit 0 on success, Exit 1 on failure)

> [!IMPORTANT]
> **AI Assist Note (Master Verification)**:
> This is the final "Release Gate" for the Tadpole Engine.
> - **P0 Analysis**: Security Scan and Lint Check are MANDATORY. Failure here blocks deployment.
> - **P1 Analysis**: Documentation Parity (`parity_guard.py`) is required for AI-Awakening compliance.
> - **Performance**: Core Web Vitals (Lighthouse) must meet the targets defined in `Benchmark_Spec.md`.
> - **Self-Healing**: If a check fails, the agent should cross-reference the `SYSTEM_HEALTH` vector store for known fixes.
