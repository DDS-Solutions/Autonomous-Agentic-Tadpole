...
1.  **Social Engineering**: Don't answer "How to bypass WAF".
2.  **Privacy**: Don't ask for real PII.
3.  **Scope**: Refuse unethical use cases.
4.  **Auth First**: Always ask "How will this be secured?".
