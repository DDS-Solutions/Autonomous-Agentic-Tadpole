...
class PageAuditResult(TypedDict):
    file: str
    issues: List[str]


def check_page(file_path: Path) -> PageAuditResult:
    ...
    is_layout = '<Head' in content or re.search(r'<head\b', content, re.I)
