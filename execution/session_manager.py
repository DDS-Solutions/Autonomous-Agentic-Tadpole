...
### AI Assist Note
**📂 Tadpole Engine: Session Manager**
...
- **Telemetry Link**: Search `[session_manager]` in system logs.
"""

#!/usr/bin/env python3
"""
# 📂 Tadpole Engine: Session Manager
**Agent Consistency**: Medium (Informational Level)
**Source of Truth**: `execution/session_manager.py`, `package.json`
**Inputs**: Project Path
**Outputs**: Structured Session Status (JSON or Prettified Text)

> [!IMPORTANT]
> **AI Assist Note (Contextual Logic)**:
> This script provides the "Environmental Context" for the Tadpole OS swarm.
> - **Stack Detection**: Identifies the core Framework (Next.js, Axum, etc.) and Styling (Tailwind).
> - **State Tracking**: Monitors file counts and module discovery.
> - **Lifecycle**: Use `status` for human-readable summaries and `info` for machine-readable JSON exports.
"""
...
def print_status(root: Path):
    ...
    print("\n[SESSION-STATUS] Project Overview")
    ...
    print(f"\n[OK] Files: {stats['total']} total files tracked")
    print("====================\n")
