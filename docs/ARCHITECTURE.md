...
| Token & Context | `server-rs/src/agent/tokenizer.rs`, `server-rs/src/agent/context_manager.rs` | Model-aware BPE token counting (< 1µs DashMap LRU cache) and 2-Tier context compression. |
