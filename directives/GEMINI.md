...
2. **Telemetry Tracing**: Trace emitters through `server-rs/src/telemetry/`, `server-rs/src/startup/mod.rs`, `server-rs/src/router.rs`, and WebSocket consumers in `src/services/`.
