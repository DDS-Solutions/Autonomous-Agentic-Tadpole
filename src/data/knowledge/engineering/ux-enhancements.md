...
The `Org_Chart` uses SVG-based connection lines that reactive to agent activity.
...
30: The `Hierarchy_Node` (Agent Card) is optimized for high-density command awareness.
