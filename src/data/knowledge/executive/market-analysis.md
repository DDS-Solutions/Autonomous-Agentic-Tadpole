...
> - **Telemetry Link**: Search `[market_analysis]` in audit logs.
>
> ### AI Assist Note
...
description: Analyzing market trends, competitors, and opportunities to inform strategy.
---
...
```mermaid
graph TD
    D[Define Market] --> G[Gather Data]
    G --> S[Segment]
    S --> C[Competitor Audit]
    C --> T[Trend Analysis]
    T --> R[Strategic Recommendation]
```
