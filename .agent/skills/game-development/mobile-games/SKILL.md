...
when_to_use: "When developing games targeting mobile platforms (iOS/Android), managing touch inputs, optimizing battery/thermals, or preparing store listings."
