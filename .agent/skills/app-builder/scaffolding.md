...
> - **Telemetry Link**: Search `[scaffolding]` in audit logs.
>
> ### AI Assist Note
> Project Scaffolding
>
...
│   │   │   ├── queries.ts          # Data fetching ('use server')
│   │   │   └── types.ts
│   │   ├── products/
│   │   │   ├── components/
│   │   │   ├── actions.ts          # Server Actions ('use server')
...
| Server action | `features/[name]/actions.ts` (Requires 'use server') |
| Data fetching | `features/[name]/queries.ts` (Requires 'use server') |
