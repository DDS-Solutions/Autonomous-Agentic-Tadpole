...
> - **Telemetry Link**: Search `[agent_coordination]` in audit logs.
>
> ### AI Assist Note
> Agent Coordination
>
...
│                     PROJECT PLANNER                          │
│  • Task breakdown                                            │
│  • Dependency graph (Reference @api-patterns for specs)      │
...
> 💡 **Tip:** The Project Planner must reference the `api-patterns` skill when defining the API dependency graph.

[//]: # (Metadata: [agent_coordination])
