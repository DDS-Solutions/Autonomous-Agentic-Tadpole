...
### AI Assist Note
**🎭 Playwright E2E Runner**: Executes high-fidelity browser tests to verify UI health, performance, and accessibility. 
Captures visual snapshots and performance timings to ensure that the sovereign interface remains functional across all supported viewports.

### 🔍 Debugging & Observability
- **Failure Path**: Browser context initialization failure or UI selector timeouts in high-latency environments.
- **Telemetry Link**: Search `[playwright_runner]` in system logs.
"""
import sys
import json
import os
...
if __name__ == "__main__":
    print("[playwright_runner] Initializing Playwright browser test suite...")
    if len(sys.argv) < 2:
        print(json.dumps({
